...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DaBko_kq.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BSIUprZ9.js").then((n2) => n2.r),
...
var ROUTER_BASEPATH = "interactive-portfolio-hub";
var SERVER_FN_BASE = "/interactive-portfolio-hub/_serverFn/";
